...
/* Tunables */
static const int sync_read_expire = (2 * HZ) / 3;	/* max time before a sync read is submitted. */
static const int sync_write_expire = 3 * HZ;	/* max time before a sync write is submitted. */

static const int async_read_expire = 5 * HZ;	/* ditto for async, these limits are SOFT! */
static const int async_write_expire = 20 * HZ;	/* ditto for async, these limits are SOFT! */
